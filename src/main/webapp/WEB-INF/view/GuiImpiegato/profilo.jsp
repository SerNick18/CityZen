        ...
        <div class="col-10">
            ...
            <div class="row justify-content-center mt-5">
                <div class="form-group col-6 align-self-center col-md-6 col-lg-6 col-xl-6">
                    ...
                    <input type="email" class="form-control boxShadow" id="nome" placeholder="${Impiegato.nome}" disabled>
                </div>
                <div class="form-group col-6 align-self-center col-md-6 col-lg-6 col-xl-6">
                    <label for="cognome" class="boldFont">Cognome</label>
                    <input type="password" class="form-control boxShadow" id="cognome" placeholder=" ${Impiegato.cognome}" disabled>
                </div>
            </div>
            <div class="row justify-content-center mt-1">
                <div class="form-group col-11 col-sm-11 col-md-8 col-lg-8 col-xl-8 mt-3">
                    ...
                    <input type="email" class="form-control boxShadow" id="inputEmail4" placeholder="${Impiegato.email}" disabled>
                </div>
            ...
            <div class="row justify-content-center mt-1">
                <div class="form-group col-11 col-sm-11 col-md-9 col-lg-9 col-xl-9 mt-3">
                    ...
                    <input type="email" class="form-control boxShadow" id="via" placeholder="${Impiegato.via}" disabled>
                </div>
                <div class="form-group col-11 col-sm-11 col-md-3 col-lg-3 col-xl-3 mt-3">
                    <label for="civico" class="boldFont">Civico</label>
                    <input type="password" class="form-control boxShadow" id="civico" placeholder=" ${Impiegato.civico}" disabled>
                </div>
            </div>
            <div class="row justify-content-center mt-5">
                <div class="form-group col-11 col-sm-11 col-md-6 col-lg-6 col-xl-6 mt-3">
                    <label class="boldFont">Segnalazioni approvate: ${Impiegato.numSegnalazioniApp}</label>
                </div>
                <div class="form-group col-11 col-sm-11 col-md-6 col-lg-6 col-xl-6 mt-3">
                    <label class="boldFont">Segnalazioni chiuse: ${Impiegato.numSegnalazioniChiuse}</label>
                </div>
            </div>
        </div>
    </div>
