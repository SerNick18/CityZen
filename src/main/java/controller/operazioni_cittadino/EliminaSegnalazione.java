...
public class EliminaSegnalazione extends HttpServlet {
    /**
     * Metodo che permette di eliminare una segnalazione.
     * Controlla se il cittadino è loggato, se non lo è lancia
     * un'eccezione. Successivamente controlla se la segnalazione
     * è nello stato inoltrata e che non è ancora stata approvata,
