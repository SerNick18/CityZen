...
public class InoltroSegnalazione extends HttpServlet {
    ...
    /**.
     * Metodo per inoltrare una segnalazione
     * @param req
     * @param resp
     * @throws ServletException
     * @throws IOException
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (req.getParameter("fromGui") != null && req.getParameter(
            ...
            if (!Pattern.matches("[0-9]{1,5}", String.valueOf(civico))) {
                throw new MyServletException(
                        "Il numero civico deve essere un numero di massimo "
                                + "5 cifre.");
            }
