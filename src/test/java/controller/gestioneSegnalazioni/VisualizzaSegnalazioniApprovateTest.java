...
public class VisualizzaSegnalazioniApprovateTest extends VisualizzaSegnalazioniApprovate{
    VisualizzaSegnalazioniApprovate servlet;
    ...
    @BeforeEach
    void setUpEach () {
        servlet = new VisualizzaSegnalazioniApprovate();
